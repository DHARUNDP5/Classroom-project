    ...
    <div>
      ...
      <div className='flex items-center justify-center'>
        ...
        <div className='flex text-center items-center justify-center'>
          <p className='text-[30px] text-white w-[1000px]'>A Student-Teacher Portal built using HTML, CSS, Python and Django Class Manager is a Student-Teacher Portal where techers and student can sign up and teachers can add students in their class.</p>
        </div>
